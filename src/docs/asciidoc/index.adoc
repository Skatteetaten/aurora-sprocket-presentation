...
== Issue #3: Cannot use Kubernetes resources
...
* transition to Bjarte: How is the ResourceQueue consumed
--
...
* transition to Kris: But what about the AffectedImages that requires approvals?
--
