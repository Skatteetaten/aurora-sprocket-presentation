...
[.notes]
--
 * Transition to issues: There are some issues with a CD pipeline
--
...
[.notes]
--
* transition Kris: So no OpenSource solution can be used, what did we do?
--
...
== Sprocket MVP
* react to notifications from Nexus notifications from DockerRegistries
...
* transition Bjarte: What steps are needed to start using it?
--
...
[.notes]
--
* transition Kris: This is as far as we are right now, but we have many plans for 1.0
--
...
* transition to Bjarte: After ImageChangeEvents are parsed and stored how do we find resources?
--
...
* transition Kris: But what about the AffectedImages that requires approvals?
--
